...
- **Business name**: Europe Jobs Consultancy Support
...
VITE_WHATSAPP_BUSINESS_NAME=Europe Jobs Consultancy Support
```
...
quickMessages: ["Your custom quick message 1", "Your custom quick message 2"];
```
