/**
 * Google Apps Script for handling both Healthcare and Course Applications
 * Deploy this as a web app with execute permissions set to "Anyone"
 * 
 * This script will:
 * 1. Detect the type of application (healthcare or course)
 * 2. Route to the appropriate sheet (Sheet1 for healthcare, Sheet2 for courses)
...
function processHealthcareApplication(data) {
  try {
    ...
    console.log("Adding healthcare application to sheet");
