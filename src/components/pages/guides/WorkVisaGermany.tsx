...
const WorkVisaGermany: React.FC = () => {
  ...
  // Create a work visa consultation job for the application form
  const workVisaJob: HealthcareJob = {
    id: "work-visa-germany-consultation",
    title: "Work Visa Germany - Consultation",
    category: "nurse",
    hospital: "EJC Work Visa Consultancy",
    location: "Germany",
    country: "Germany",
    ...
    description:
      "Get expert guidance for work visa applications to Germany including EU Blue Card, general work permits, and job seeker visas.",
    requirements: [
      "University degree or vocational training",
      "Job offer or job search plan",
    ...
    contactEmail: "workvisa@ejcgroup.eu",
    isActive: true,
  };
  ...
  const structuredData = {
    ...
    "@type": "Article",
    headline:
      "Complete Guide to Work Visa Germany - Requirements & Process 2024",
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
                Complete Guide & Requirements - EU Blue Card, Job Seeker Visa &
                Work Permits
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
                  ...
                  {[
                    {
                      ...
                      requirements:
                        "University degree + job offer with €56,800+ salary",
                    ...
                    },
                    {
                      ...
                      description:
                        "For skilled workers with vocational training or experience",
              ...
              <div className="bg-white rounded-lg shadow-md p-6 mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">
                  EU Blue Card Requirements (Most Popular)
                </h2>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    },
                    {
                      ...
                      description:
                        "Collect all required documents and translations",
                      duration: "2-4 weeks",
                    },
                    {
                      step: 4,
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-gradient-to-br from-blue-600 to-indigo-600 text-white rounded-lg p-6 mb-6">
                <h3 className="text-xl font-bold mb-4">
                  Get Work Visa Assessment
                </h3>
                <p className="mb-6">
                  Check your eligibility for Germany work visa and get expert
                  guidance.
                </p>
                <button
                  onClick={handleApplyClick}
              ...
              <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div className="border-l-4 border-blue-500 pl-4">
                  <p className="text-gray-600 italic mb-3">
                    "EJC helped me get EU Blue Card in just 3 weeks. Now I'm
                    working as a software engineer in Berlin earning €75,000 per
                    year!"
                  </p>
