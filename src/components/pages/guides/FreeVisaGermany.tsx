...
const FreeVisaGermany: React.FC = () => {
  ...
  // Create a visa consultation job for the application form
  const visaJob: HealthcareJob = {
    id: "free-visa-germany-consultation",
    title: "Free Visa Germany - Consultation",
    category: "nurse",
    hospital: "EJC Visa Consultancy",
    location: "Germany",
    country: "Germany",
    ...
    description:
      "Get expert guidance for free visa options to Germany including scholarship visas, family reunification, and work visa fee waivers.",
    requirements: [
      "Valid passport",
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
                7 Proven Ways to Get Germany Visa Fee Waiver - Save €75-€150 on
                Your Application
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-white rounded-lg shadow-md p-6 mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">
                  7 Ways to Get Free Visa for Germany
                </h2>
                  ...
                  {[
                    {
                      ...
                      description:
                        "Students with DAAD scholarships get automatic visa fee waiver",
                    ...
                    },
                    {
                      ...
                      description:
                        "Skilled professionals with job offers may get fee waiver",
                  ...
                  {[
                    {
                      ...
                      description:
                        "Verify if you qualify for any of the 7 free visa categories",
                    },
                    {
                      step: 2,
                      title: "Gather Supporting Documents",
                      description:
                        "Collect proof of scholarship, job offer, or family relationship",
                    },
                    {
                      step: 3,
                    ...
                    },
                    {
                      ...
                      description:
                        "Include fee waiver justification with your application",
                    },
                    {
                      step: 5,
                    ...
                    },
                    {
                      ...
                      description:
                        "Get visa approval without paying standard fees",
                    },
                  ].map((item) => (
              ...
              <div className="bg-white rounded-lg shadow-md p-6 mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">
                  Tips for Successful Fee Waiver Application
                </h2>
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-gray-600">
                        Submit your application 3-4 months before travel date
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-gray-600">
                        Ensure all supporting documents are authentic and
                        translated
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-gray-600">
                        Get expert guidance to maximize your chances of approval
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-gradient-to-br from-green-600 to-teal-600 text-white rounded-lg p-6 mb-6">
                ...
                <p className="mb-6">
                  Check if you qualify for Germany visa fee waiver and save
                  €75-€150.
                </p>
                <button
                  onClick={handleApplyClick}
              ...
              <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div className="border-l-4 border-green-500 pl-4">
                  <p className="text-gray-600 italic mb-3">
                    "Thanks to EJC, I got my student visa for free through DAAD
                    scholarship. Saved €75 and got expert guidance throughout
                    the process!"
                  </p>
                  <div className="text-sm">
                    <div className="font-semibold">Ankit Kumar</div>
                    <div className="text-gray-500">
                      MS Engineering, TU Berlin
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div className="space-y-3">
                  ...
                  <a
                    href="/guides/doctors-jobs-germany"
                    className="block text-blue-600 hover:text-blue-800 transition-colors"
                  >
