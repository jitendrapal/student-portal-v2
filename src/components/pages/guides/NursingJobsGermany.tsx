...
const NursingJobsGermany: React.FC = () => {
  ...
  // Create a sample nursing job for the application form
  const nursingJob: HealthcareJob = {
    id: "nursing-germany-guide",
    title: "Nursing Position in Germany",
    category: "nurse",
    hospital: "German Healthcare Network",
    ...
    description:
      "Nursing opportunities across Germany with visa sponsorship and comprehensive support.",
    requirements: [
    ...
    contactEmail: "nursing@ejcgroup.eu",
    isActive: true,
  };
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
                Complete Guide for Indian Nurses - Visa Support, High Salaries &
                Career Growth
              </p>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-white rounded-lg shadow-md p-6 mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">
                  Why Choose Nursing Jobs in Germany?
                </h2>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-gray-600">
                        Bachelor's degree in Nursing from recognized Indian
                        institution
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-gray-600">
                        B2 level German proficiency (we provide language
                        training)
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-gray-600">
                        Minimum 2 years of nursing experience in India
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                  ...
                  {[
                    {
                      ...
                      description:
                        "Free evaluation of your nursing qualifications and experience",
                    },
                    {
                      step: 2,
                      title: "Document Preparation",
                      description:
                        "Assistance with degree recognition and document translation",
                    },
                    {
                      step: 3,
                      title: "German Language Training",
                      description:
                        "Intensive B2 level German course (6-12 months)",
                    },
                    {
                      step: 4,
                      title: "Job Matching",
                      description:
                        "Connect with German hospitals and healthcare facilities",
                    },
                    {
                      step: 5,
                      title: "Visa Application",
                      description:
                        "Complete visa support and application assistance",
                    },
                    {
                      step: 6,
                      title: "Relocation Support",
                      description:
                        "Help with accommodation, banking, and settling in Germany",
                    },
                  ].map((item) => (
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-gradient-to-br from-blue-600 to-purple-600 text-white rounded-lg p-6 mb-6">
                <h3 className="text-xl font-bold mb-4">
                  Start Your Nursing Career in Germany
                </h3>
                <p className="mb-6">
                  Get free consultation and assessment of your nursing
                  qualifications.
                </p>
                <button
                  onClick={handleApplyClick}
