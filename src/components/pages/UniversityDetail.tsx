...
import { 
  MapPin, Star, Users, DollarSign, ExternalLink, Calendar, 
  Award, Building, Globe, BookOpen, ArrowLeft, Heart 
} from 'lucide-react';
import { useStore } from '../../store/useStore';

const UniversityDetail: React.FC = () => {
  const { universities, getCoursesByUniversity, setCurrentPage, user, isAuthenticated } = useStore();
  const [activeTab, setActiveTab] = useState<'overview' | 'courses' | 'admissions' | 'reviews'>('overview');
  const [isFavorited, setIsFavorited] = useState(false);

  // For demo purposes, using the first university
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                {university.ranking.world && (
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="font-semibold">#{university.ranking.world}</div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              ...
              {university.images && university.images.length > 0 && (
                <div className="bg-white rounded-lg shadow-sm p-6">
                  <h2 className="text-xl font-semibold text-gray-900 mb-4">Campus</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium capitalize">{university.type}</span>
                  </div>
                  <div className="flex justify-between">
              ...
              {/* Partnerships */}
              {university.partnerships && university.partnerships.length > 0 && (
                <div className="bg-white rounded-lg shadow-sm p-6">
                  ...
                  <div key={course.id} className="border border-gray-200 rounded-lg p-6">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                      ...
                      <div className="mt-4 md:mt-0 text-right">
                        ...
                        <div className="text-sm text-gray-600">per {course.tuitionFee.period}</div>
                      </div>
                    </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="prose max-w-none">
              <p className="text-gray-600 mb-6">
                General admission requirements for {university.name}. Specific requirements may vary by program.
              </p>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <div className="font-medium text-gray-900">Spring Intake</div>
        ...
        {activeTab === 'reviews' && (
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="text-center py-12 text-gray-500">
              ...
              <p className="text-sm mt-2">Be the first to share your experience at {university.name}</p>
            </div>
          </div>
        )}
      </div>
