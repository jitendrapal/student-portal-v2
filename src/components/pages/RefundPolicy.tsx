        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              At Europe Jobs Consultancy, we are committed to providing
              high-quality services and ensuring your satisfaction. This Refund
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-blue-800">
                <strong>Important:</strong> Please read this policy carefully
                before purchasing our services. By making a payment, you
              ...
              <div className="border border-gray-200 rounded-lg p-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
                      <li>
                        Service cancelled before work begins (100% refund)
                      </li>
                      <li>
                        Service cancelled after initial review (50% refund)
                      </li>
                      <li>
                        University changes admission requirements significantly
                      </li>
                    </ul>
                  </div>
                  <div>
              ...
              <div className="border border-gray-200 rounded-lg p-6">
                ...
                <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
                  <p className="text-red-800 text-sm">
                    <strong>Limited Refund Policy:</strong> Due to the extensive
                    nature of these services, refunds are only available under
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
                      ...
                      <li>
                        Cancellation within 7 days of purchase (before work
                        begins)
                      </li>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-sm">
                    Submit refund request via email or phone within 30 days of
                    service date
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-sm">
                    We review your request within 5-7 business days
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-sm">
                    You'll receive our decision via email with detailed
                    explanation
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-green-500 pl-6">
                ...
                <p className="text-gray-700 text-sm">
                  ...
                  government restrictions, etc.), we will work with you to
                  reschedule services or provide appropriate compensation.
                </p>
              </div>
              ...
              <div className="border-l-4 border-blue-500 pl-6">
                ...
                <p className="text-gray-700 text-sm">
                  If you're unsatisfied with service quality, we'll first
                  attempt to resolve the issue through additional support or
                  service corrections before considering refunds.
                </p>
              </div>
              ...
              <div className="border-l-4 border-yellow-500 pl-6">
                ...
                <p className="text-gray-700 text-sm">
                  If universities change their admission requirements or
                  policies after we begin work, we'll adapt our services
                  accordingly or discuss refund options.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center text-gray-700">
                  ...
                  <span>
                    <strong>Email:</strong> refunds@ejcgroup.eu
                  </span>
                </div>
                <div className="flex items-center text-gray-700">
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal list-inside text-gray-700 space-y-2">
              ...
              <li>
                Pursue resolution through appropriate legal channels if
                necessary
              </li>
            </ol>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              be posted on our website and will apply to services purchased
              after the effective date. For services purchased before policy
              changes, the original policy terms will apply.
            </p>
          </section>
        </div>
      </div>
