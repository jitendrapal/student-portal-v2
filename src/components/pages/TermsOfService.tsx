...
import { ArrowLeft, FileText, Users, AlertTriangle, Scale, CreditCard, Shield } from 'lucide-react';
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              These Terms of Service ("Terms") govern your use of Europe Job Center's website and services. 
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-medium text-gray-900 mb-2">Service Fees</h3>
                <ul className="list-disc list-inside text-gray-700 space-y-1">
                  <li>Consultation fees are due upon booking</li>
                  <li>Application processing fees are non-refundable once work begins</li>
                  <li>Payment plans may be available for comprehensive packages</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              All content, features, and functionality of our services are owned by Europe Job Center 
          ...
          <section className="mb-8">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-4">
              <p className="text-gray-700 leading-relaxed mb-4">
                <strong>No Guarantee of Admission or Employment:</strong> While we provide professional 
                guidance and support, we cannot guarantee university admission or job placement.
              </p>
              <p className="text-gray-700 leading-relaxed">
                <strong>Third-Party Decisions:</strong> University admissions and employer hiring decisions 
                are made independently and are beyond our control.
              </p>
            </div>
            <ul className="list-disc list-inside text-gray-700 space-y-2">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2">
              ...
              <li>Your data may be shared with universities and employers as needed</li>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  relieve you of payment obligations for services already provided.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  We may terminate or suspend your access for violations of these Terms, non-payment, 
          ...
          <section className="mb-8">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <p className="text-gray-700 mb-2">
                <strong>Europe Job Center</strong><br />
                Email: legal@ejcgroup.eu<br />
                Phone: +31 620 371 533<br />
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              of the modified Terms. We will notify users of significant changes via email or 
